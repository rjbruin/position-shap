...
get_tokens = True
settings = [
    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=2, n_blocks=1,  pos_emb_factor=0.1,  pos_add='add',           shap_bg_folds='all', seeds=range(3), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=2, n_blocks=4,  pos_emb_factor=0.1,  pos_add='add',           shap_bg_folds='all', seeds=range(3), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=2, n_blocks=8,  pos_emb_factor=0.1,  pos_add='add',           shap_bg_folds='all', seeds=range(3), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=2, n_blocks=12, pos_emb_factor=0.1,  pos_add='add',           shap_bg_folds='all', seeds=range(3), **base_settings),

    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=2, n_blocks=1,  pos_emb_factor=0.1,  pos_add='add',           shap_bg_folds=5,     seeds=range(3), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=2, n_blocks=4,  pos_emb_factor=0.1,  pos_add='add',           shap_bg_folds=5,     seeds=range(3), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=2, n_blocks=8,  pos_emb_factor=0.1,  pos_add='add',           shap_bg_folds=5,     seeds=range(3), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=2, n_blocks=12, pos_emb_factor=0.1,  pos_add='add',           shap_bg_folds=5,     seeds=range(3), **base_settings),

    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=2, n_blocks=4,  pos_emb_factor=0.1,  pos_add='concat_equald', shap_bg_folds='all', seeds=range(3), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=2, n_blocks=8,  pos_emb_factor=0.1,  pos_add='concat_equald', shap_bg_folds='all', seeds=range(3), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=2, n_blocks=12, pos_emb_factor=0.1,  pos_add='concat_equald', shap_bg_folds='all', seeds=range(3), **base_settings),
]
