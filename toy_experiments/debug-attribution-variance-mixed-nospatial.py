...
run_name = 'run22-sens+shap-mixed+test-nospatial'
save_plots = True
# len(settings) = 30
settings = [
    Setting(lr=4e-3, weight_decay=1e-3, d=8 , n_heads=2, n_blocks=1, pos_emb_factor=0.1,  pos_add='add',           seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=12, n_heads=2, n_blocks=1, pos_emb_factor=0.1,  pos_add='add',           seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=2, n_blocks=1, pos_emb_factor=0.1,  pos_add='add',           seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=8 , n_heads=4, n_blocks=1, pos_emb_factor=0.1,  pos_add='add',           seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=12, n_heads=4, n_blocks=1, pos_emb_factor=0.1,  pos_add='add',           seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=4, n_blocks=1, pos_emb_factor=0.1,  pos_add='add',           seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=20, n_heads=4, n_blocks=1, pos_emb_factor=0.1,  pos_add='add',           seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=24, n_heads=4, n_blocks=1, pos_emb_factor=0.1,  pos_add='add',           seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=18, n_heads=6, n_blocks=1, pos_emb_factor=0.1,  pos_add='add',           seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=24, n_heads=6, n_blocks=1, pos_emb_factor=0.1,  pos_add='add',           seeds=range(10), **base_settings),

    Setting(lr=4e-3, weight_decay=1e-3, d=8 , n_heads=2, n_blocks=1, pos_emb_factor=0.1,  pos_add='concat_equald', seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=12, n_heads=2, n_blocks=1, pos_emb_factor=0.1,  pos_add='concat_equald', seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=2, n_blocks=1, pos_emb_factor=0.1,  pos_add='concat_equald', seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=8 , n_heads=4, n_blocks=1, pos_emb_factor=0.1,  pos_add='concat_equald', seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=12, n_heads=4, n_blocks=1, pos_emb_factor=0.1,  pos_add='concat_equald', seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=16, n_heads=4, n_blocks=1, pos_emb_factor=0.1,  pos_add='concat_equald', seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=20, n_heads=4, n_blocks=1, pos_emb_factor=0.1,  pos_add='concat_equald', seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=24, n_heads=4, n_blocks=1, pos_emb_factor=0.1,  pos_add='concat_equald', seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=18, n_heads=6, n_blocks=1, pos_emb_factor=0.1,  pos_add='concat_equald', seeds=range(10), **base_settings),
    Setting(lr=4e-3, weight_decay=1e-3, d=24, n_heads=6, n_blocks=1, pos_emb_factor=0.1,  pos_add='concat_equald', seeds=range(10), **base_settings),
]
