...
train_images, train_labels, test_images, test_labels, n_classes = datasets.dataset_appearance_absolute_position(size=[8,8], colors=['red'], pos_colors=['red'], split_quadrants=True)
...
# Run 19: wide search on position-only toy, run on cluster
run_name = 'run19-sens+shap-pos-p2+test-fixsave2'
save_plots = True
# len(settings) = 30
settings = [
