...
train_images, train_labels, test_images, test_labels, n_classes = datasets.dataset_appearance_absolute_position(size=[8,8], colors=['red', 'green'], pos_colors=[], split_quadrants=True)
print(f"{n_classes} classes")
...
run_name = 'run18-sens+shap-app-p2+test-fixsave2'
save_plots = True
# len(settings) = 30
settings = [
