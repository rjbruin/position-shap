...
from published_models.model_implementations.google_research_vit.pos_embed_rel import RelPosMlp, RelPosBias
...
def vit_relpos_small_patch16_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    ...
    """
    model_args = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, **vit_matching_config)
...
def vit_relpos_medium_patch16_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    ...
    """
    model_args = dict(
        patch_size=16, embed_dim=512, depth=12, num_heads=8, **vit_matching_config)
    model = _create_vision_transformer_relpos(
...
def vit_relpos_base_patch16_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    ...
    """
    model_args = dict(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, **vit_matching_config)
    model = _create_vision_transformer_relpos(
