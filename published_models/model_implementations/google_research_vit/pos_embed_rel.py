...
def gen_relative_position_index(
    ...
    if class_token:
        ...
        # # relative_position_index = F.pad(relative_position_index, [1, 0])
        # relative_position_index[0, 0:] = num_relative_distance - 3
        # relative_position_index[0:, 0] = num_relative_distance - 2
        # relative_position_index[0, 0] = num_relative_distance - 1

        # DEBUG
        relative_position_index = F.pad(relative_position_index, [3, 0])
        relative_position_index[0] = num_relative_distance - 3
        relative_position_index[1] = num_relative_distance - 2
        relative_position_index[2] = num_relative_distance - 1
...
class RelPosMlp(nn.Module):
    ...
    def __init__(
        ...
        self.register_buffer(
            "relative_position_index",
            gen_relative_position_index(window_size, class_token=prefix_tokens > 0).view(-1),
            persistent=False)
