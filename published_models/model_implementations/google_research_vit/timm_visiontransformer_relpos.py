...
Adapted by xxx for this project.
"""
import logging
import math
...
from timm.layers import RelPosBias
...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.fused_attn:
            ...
            if self.rel_pos is not None:
                attn = self.rel_pos(attn, shared_rel_pos=None)
...
class VisionTransformerRelPos(nn.Module):
    ...
    Adapted for this project to support RPE.
    """
    ...
    def __init__(
        ...
        # NOTE: added code for RPE (bias mode)
        rel_pos_cls = None
        if rpe:
...
@torch.no_grad()
def _load_weights(model: VisionTransformerRelPos, checkpoint_path: str, prefix: str = ''):
...
@register_model
def vit_tiny_patch16_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-Tiny (Vit-Ti/16)
    """
...
@register_model
def vit_tiny_patch16_384(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_small_patch32_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-Small (ViT-S/32)
    """
...
@register_model
def vit_small_patch32_384(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_small_patch16_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-Small (ViT-S/16)
    """
...
@register_model
def vit_small_patch16_384(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-Small (ViT-S/16)
    """
    model_args = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6)
...
@register_model
def vit_small_patch8_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-Small (ViT-S/8)
    """
...
@register_model
def vit_base_patch32_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_base_patch32_384(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_base_patch16_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_base_patch16_384(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_base_patch8_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_large_patch32_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_large_patch32_384(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_large_patch16_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_large_patch16_384(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-Large model (ViT-L/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 384x384, source https://github.com/google-research/vision_transformer.
    """
    model_args = dict(patch_size=16, embed_dim=1024, depth=24, num_heads=16)
...
@register_model
def vit_large_patch14_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_huge_patch14_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_giant_patch14_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_gigantic_patch14_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_base_patch16_224_miil(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
...
@register_model
def vit_medium_patch16_gap_240(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_medium_patch16_gap_256(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_medium_patch16_gap_384(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_base_patch16_gap_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_base_patch32_clip_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_base_patch32_clip_384(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_base_patch32_clip_448(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_base_patch16_clip_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_base_patch16_clip_384(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_large_patch14_clip_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_large_patch14_clip_336(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_huge_patch14_clip_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_huge_patch14_clip_336(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_giant_patch14_clip_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-Giant (little-g) model (ViT-g/14) from `Scaling Vision Transformers` - https://arxiv.org/abs/2106.04560
...
@register_model
def vit_gigantic_patch14_clip_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_base_patch32_plus_256(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-Base (ViT-B/32+)
    """
...
@register_model
def vit_base_patch16_plus_240(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-Base (ViT-B/16+)
    """
...
@register_model
def vit_base_patch16_rpn_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_small_patch16_36x1_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_small_patch16_18x2_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_base_patch16_18x2_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def eva_large_patch14_196(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def eva_large_patch14_336(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ EVA-large model https://arxiv.org/abs/2211.07636 via MAE MIM pretrain"""
    model_args = dict(patch_size=14, embed_dim=1024, depth=24, num_heads=16, global_pool='avg')
...
@register_model
def flexivit_small(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ FlexiViT-Small
    """
...
@register_model
def flexivit_base(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ FlexiViT-Base
    """
...
@register_model
def flexivit_large(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ FlexiViT-Large
    """
...
@register_model
def vit_base_patch16_xp_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_large_patch14_xp_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-Large model (ViT-L/14) w/ parallel blocks and qk norm enabled.
    """
    model_args = dict(
...
@register_model
def vit_huge_patch14_xp_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
...
@register_model
def vit_small_patch14_dinov2(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-S/14 for DINOv2
    """
    model_args = dict(
...
@register_model
def vit_base_patch14_dinov2(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-B/14 for DINOv2
    """
    model_args = dict(
...
@register_model
def vit_large_patch14_dinov2(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-L/14 for DINOv2
    """
    model_args = dict(
...
@register_model
def vit_giant_patch14_dinov2(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-G/14 for DINOv2
    """
